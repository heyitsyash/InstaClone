...
//        val profileImage:ImageView = view.findViewById(R.id.post_feed_image)
//        val nameText:TextView = view.findViewById(R.id.post_user_name)
//        val placeText :TextView = view.findViewById(R.id.post_place_text)
